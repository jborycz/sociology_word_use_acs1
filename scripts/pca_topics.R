...
# diff_lim_agg
dt_order <- unique(diff_lim_agg_all_pca[order(diff_lim_agg_all_pca$max_depth),]$max_depth)
diff_lim_agg_all_pca$max_depth <- factor(diff_lim_agg_all_pca$max_depth,levels=dt_order)
